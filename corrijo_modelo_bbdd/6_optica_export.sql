...
--
-- Servidor: localhost
-- Tiempo de generación: 27-07-2020 a las 00:49:19
...
INSERT INTO `Marcas` (`nombre`, `id_marca`) VALUES
('Marca1', 1),
('Marca2', 3),
('Marca3', 4),
('Marca8', 6),
...
CREATE TABLE `recomienda` (
  `cliente` int(11) NOT NULL,
  `cliente_recomienda` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `recomienda`
  ADD PRIMARY KEY (`cliente`,`cliente_recomienda`),
  ADD KEY `cliente_recomienda` (`cliente_recomienda`);
...
--
ALTER TABLE `recomienda`
  ADD CONSTRAINT `recomienda_ibfk_1` FOREIGN KEY (`cliente`) REFERENCES `clientes` (`id_cliente`),
  ADD CONSTRAINT `recomienda_ibfk_2` FOREIGN KEY (`cliente_recomienda`) REFERENCES `clientes` (`id_cliente`);
COMMIT;
